    ...
    <div class="site-branding-area">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    <div class="logo">
                        <h1><a href="index.php" style="color: #333; font-family: fantasy;"><b>ITECHNEW.VN</b></a></h1>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li><a href="index.php?mod=hanghoa&act=new" onclick="return isActive()">Sản Phẩm</a></li>
                        <li><a href="index.php?mod=cart&act=detail">Giỏ Hàng</a></li>
                        <li><a href="admin.php?mod=hanghoa&act=manage">Quản lý</a></li>
                </div>  
                <?php
                    include_once("Controller/Cart/Cart.php");
                ?>
